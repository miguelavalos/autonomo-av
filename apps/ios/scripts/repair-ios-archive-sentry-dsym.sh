...
usage() {
  cat <<'USAGE'
Usage:
  scripts/repair-ios-archive-sentry-dsym.sh --archive <AutonomoAV.xcarchive>

Generates the dSYM for Xcode's Sentry.framework stub inside an Autonomo AV iOS
...
sentry_binary="$archive_path/Products/Applications/AutonomoAV.app/Frameworks/Sentry.framework/Sentry"
